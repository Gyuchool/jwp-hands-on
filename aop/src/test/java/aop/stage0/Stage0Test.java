...
class Stage0Test {
    ...
    void testChangePassword() {
        ...
        final UserService userService = createJdkDynamicProxy(appUserService, UserService.class);
    ...
    private <T> T createJdkDynamicProxy(final Object target, final Class<T> proxyInterface) {
